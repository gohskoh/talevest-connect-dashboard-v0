-- Update the process_airdrop_claim function to give 0.111111 TVST per day (10 TVST in 3 months)
...
DECLARE
  ...
  v_tvst_amount decimal(18,8) := 0.111111; -- Updated to allow 10 TVST in 3 months
BEGIN
  -- Get current user ID
  v_user_id := auth.uid();
  ...
  RETURN jsonb_build_object(
    ...
    'message', 'Successfully claimed 0.111111 TVST!'
  );
END;
$$;

-- Update the default value in user_airdrop_claims table
ALTER TABLE public.user_airdrop_claims ALTER COLUMN tvst_earned SET DEFAULT 0.111111;